...
<div class="navsec">
  ...
  <h1 class="font-weight-bold"> <?php echo  ' Hi - '.$_SESSION["admin"].' '?></h1><br>
  <ul>
      <br>
      <li> <a class="navbar-brand" href="AdminEntry.php"> Dashboard</a>  </li> <br>
      <li> <a class="navbar-brand" href="adduser.php"> Manage user</a>  </li> <br>
      ...
      <li>   <a class="navbar-brand" href="#">Orders</a> </li> <br>
